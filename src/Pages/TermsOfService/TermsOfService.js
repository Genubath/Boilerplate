      ...
      <Jumbotron className="jumbotron">
        ...
        <ol type="a">
          <li>
            ...
            materials (information or software) on name's web site for personal,
          ...
          <li>
            ...
            these restrictions and may be terminated by name at any time. Upon
        ...
        <ol type="a">
          <li>
            The materials on name's web site are provided "as is". name makes no
            ...
            other violation of rights. Further, name does not warrant or make
        ...
        <p>
          In no event shall name or its suppliers be liable for any damages
          (including, without limitation, damages for loss of data or profit, or
          due to business interruption,) arising out of the use or inability to
          use the materials on name's Internet site, even if name or a name
        ...
        <p>
          The materials appearing on name's web site could include technical,
          typographical, or photographic errors. name does not warrant that any
          of the materials on its web site are accurate, complete, or current.
          name may make changes to the materials contained on its web site at
          any time without notice. name does not, however, make any commitment
        ...
        <p>
          name has not reviewed all of the sites linked to its Internet web site
          and is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement by name of the site.
        ...
        <p>
          name may revise these terms of use for its web site at any time
        ...
        <p>
          Any claim relating to name's web site shall be governed by the laws of
          the State of state without regard to its conflict of law provisions.
        </p>
